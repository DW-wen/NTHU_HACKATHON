...
async def handle_client(websocket: Any):
    ...
    try:
        ...
        print(f"[Server] Client connected assigned id={player_id}")
        ...
        async for message in websocket:
            try:
                ...
                if msg_type == "player_update":
                    ...
                    PLAYER_HANDLER.update(player_id, x, y, map_name, direction=direction, moving=bool(moving) if moving is not None else None)
        ...
        if player_id >= 0:
            ...
            print(f"[Server] Client id={player_id} disconnected")
        async with CLIENTS_LOCK:
